...
constexpr auto OPTIONAL_DELAY1_DEFER1_P = R"((\s*;\s+delay\[\s*1\s*]\s*,\s+defer\s*\[\s*1\s*])?)";
...
static inline int compose_shft(const smatch &m, const machine_code &code) {
    ...
    if (mcode.op_00100.inline_flg && !m.str(11).empty()) {
        return -1;
    }
    return 0;
}
...
const u64_regex_map parser_assembler::opcode_regex_map = {
    ...
    {0b00011, regex(string(CODE_LINE_PREFIX_P) + P_00010_00011 + CODE_LINE_POSFIX_P)},
    {0b00010, regex(string(CODE_LINE_PREFIX_P) + P_00010_00011 + CODE_LINE_POSFIX_P)},
    ...
    {0b00111, regex(string(CODE_LINE_PREFIX_P) + P_00111 + CODE_LINE_POSFIX_P)},
    {0b00101, regex(string(CODE_LINE_PREFIX_P) + P_00101_00110 + CODE_LINE_POSFIX_P)},
    {0b00110, regex(string(CODE_LINE_PREFIX_P) + P_00101_00110 + CODE_LINE_POSFIX_P)},
    {0b01000, regex(string(CODE_LINE_PREFIX_P) + P_01000_01101_01110_01111 + CODE_LINE_POSFIX_P)},
    {0b00100, regex(string(CODE_LINE_PREFIX_P) + P_00100 + OPTIONAL_DELAY1_P + CODE_LINE_POSFIX_P)},
    {0b01001, regex(string(CODE_LINE_PREFIX_P) + P_01001 + CODE_LINE_POSFIX_P)},
    {0b01100, regex(string(CODE_LINE_PREFIX_P) + P_01100 + OPTIONAL_DELAY1_DEFER1_P + CODE_LINE_POSFIX_P)},
    {0b01011, regex(string(CODE_LINE_PREFIX_P) + P_01010_01011 + OPTIONAL_DELAY1_DEFER1_P + CODE_LINE_POSFIX_P)},
    {0b01010, regex(string(CODE_LINE_PREFIX_P) + P_01010_01011 + OPTIONAL_DELAY1_DEFER1_P + CODE_LINE_POSFIX_P)},
    {0b01111, regex(string(CODE_LINE_PREFIX_P) + P_01000_01101_01110_01111 + CODE_LINE_POSFIX_P)},
    {0b01110, regex(string(CODE_LINE_PREFIX_P) + P_01000_01101_01110_01111 + CODE_LINE_POSFIX_P)},
    {0b01101, regex(string(CODE_LINE_PREFIX_P) + P_01000_01101_01110_01111 + CODE_LINE_POSFIX_P)},
    {0b10000, regex(string(CODE_LINE_PREFIX_P) + P_10000 + CODE_LINE_POSFIX_P)},
    {0b10001, regex(string(CODE_LINE_PREFIX_P) + P_10001 + OPTIONAL_DELAY1_P + CODE_LINE_POSFIX_P)},
    {0b10011, regex(string(CODE_LINE_PREFIX_P) + P_10011 + CODE_LINE_POSFIX_P)},
    {0b10010, regex(string(CODE_LINE_PREFIX_P) + P_10010 + CODE_LINE_POSFIX_P)}
};

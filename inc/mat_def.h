...
constexpr auto P_00001 =
    R"((\d{1,10}|0[xX][\dA-Fa-f]{1,8}|AD\s*\[\s*([0-9]|[12][0-9]|3[0-6])\s*])\s*,\s+)"
...
constexpr auto P_00010 =
    R"((\d{1,5}|0[xX][\dA-Fa-f]{1,4}|AD\s*\[\s*([0-9]|[12][0-9]|3[0-8])\s*])\s*,\s+)"
...
constexpr auto P_00100 =
    R"(((0[xX][\dA-Fa-f]{1,6})|AD\s*\[\s*([0-9]|[12][0-9]|3[0-7])\s*])?)";

constexpr auto P_00101 =
    R"(((0[xX][\dA-Fa-f]{1,3})\s*,\s+|AD\s*\[\s*([0-9]|[12][0-9]|3[0-8])\s*]\s*,\s+)?)"
...
constexpr auto P_10100 =
    ...
    R"(AD\s*\{\s*([0-9]|1[0-9]|2[0-4])\s*:\s*([1-4])\s*\})\s*,\s+)"
    R"(PHV\s*\[\s*([0-9]|[1-9][0-9]|[1-4][0-9]{2}|50[0-9]|51[01])\s*])";
...
constexpr auto P_10111_11000 =
    ...
    R"((0[xX][\dA-Fa-f]{1,9}|AD\s*\{\s*([0-9]|[12][0-9]|3[0-7])\s*:\s*([0-7])\s*\})\s*,\s+([0-3]))";

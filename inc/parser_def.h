...
const string P_10001 = assembler::normal_line_prefix_p +
    R"((ISR\s*\{\s*([0-9]|[12][0-9]|3[0-2])\s*:\s*([0-9]|[123][0-9]|40)\s*\}\s*,\s+)?)"
    R"((META\s*\{\s*([0-9]|[1-9][0-9]|[1-4][0-9]{2}|50[0-9]|51[01])\s*:\s*([0-9]|[123][0-9]|40)\s*\}\s*,\s+)?)"
    R"((>>([0-9]|[12][0-9]|3[0-2])\s*,\s+)?->([0-9]|[1-9][0-9]{1,2}|2[0-4][0-9]|25[0-5]))"
    + assembler::normal_line_posfix_p;

const string P_10010_10011 = assembler::normal_line_prefix_p +
    R"((>>([0-9]|[12][0-9]|3[0-2]))?)" + assembler::normal_line_posfix_p;
